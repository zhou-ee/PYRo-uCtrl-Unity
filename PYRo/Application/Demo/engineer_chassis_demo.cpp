...
void chassis_get_mode(pyro::rc_drv_t *rc_drv)
{
    ...
    vx_rc = static_cast<float>(p_ctrl->rc.ch[3]) / 660.0f ;
    vy_rc = -static_cast<float>(p_ctrl->rc.ch[2]) / 660.0f ;
    wz_rc = -static_cast<float>(p_ctrl->rc.ch[0]) / 660.0f *5;
}
...
void pyro_engineer_chassis_demo(void *arg)
{
        ...
        wheel_motor1 = new pyro::dji_m3508_motor_drv_t(pyro::dji_motor_tx_frame_t::id_1, pyro::can_hub_t::can3);
        wheel_motor2 = new pyro::dji_m3508_motor_drv_t(pyro::dji_motor_tx_frame_t::id_2, pyro::can_hub_t::can3);
        wheel_motor3 = new pyro::dji_m3508_motor_drv_t(pyro::dji_motor_tx_frame_t::id_3, pyro::can_hub_t::can3);
        wheel_motor4 = new pyro::dji_m3508_motor_drv_t(pyro::dji_motor_tx_frame_t::id_4, pyro::can_hub_t::can3);
