...
void shoot_base_t::dr16_cmd()
{
    ...
    if(RC_CONTROL == _total_mode)
    {
        ...
        case dr16_drv_t::DR16_SW_DOWN:
            if(dr16_drv_t::DR16_SW_DOWN == static_cast<uint8_t>(p_last_ctrl->rc.s[dr16_drv_t::DR16_SW_LEFT]))
            {
                _continuous_delay++;
            ...
            else if(dr16_drv_t::DR16_SW_MID == static_cast<uint8_t>(p_last_ctrl->rc.s[dr16_drv_t::DR16_SW_LEFT]))
            {
                _continuous_delay = 0;
